...
void multiplos3y5() //inicio del main
{
    int num, i, sumaMult3, contMult3, contMult5, sumaMult5, opcion;
    bool esMultiplo, ejecucion = true;
    while (ejecucion)
    {
        mostrarMenus(5);
        ...
        case 1:
            {
                ...
                if (num < 0 || num > 1000)
                {
                    cout << "El numero debe estar entre 0 y 1000" << endl;
                    break; // Termina el codigo si el valor es invalido
                }
                ...
                cout << endl << "Total de multiplos de 3:" << contMult3 << endl;
